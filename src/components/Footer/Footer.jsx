...
<div className='footer-blocks' >
            ...
            <div  className='footer-block3 block-block' >
                ...
                <div>
                    <a href="">
                        <box-icon className="icon" color="steelblue"  type='logo' name='instagram-alt'></box-icon> 
</a>
<a href=""><box-icon className="icon" color="steelblue"  name='facebook-circle' type='logo' ></box-icon>
</a>
<a href="">                <box-icon  className="icon" color="steelblue"  name='twitter' type='logo' ></box-icon>
</a>
                 </div>
            </div>
